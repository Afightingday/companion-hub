...
- 图形偏艺术化、个性化，不要求用户仅凭图形猜出工具功能；功能由旁边文字说明。
...
一根墨线从偏心位置生长，像雨水在曲面上试探。它两次接近自己却不闭合，随后从另一方向继续寻找，形成永远未完成的流形。

### 搜索｜听雨

两条极细弧线从不同方向掠过，中间短暂产生一个交点；交点闪过一点雨蓝，然后弧线继续远离。感觉像在大量声音里捕捉一次回应。
...
先通过 CI 产出 MP4，让用户比较线宽、速度、曲率和存在感。两枚原型定稿后，再扩展其余动画，避免整套一起返工。
